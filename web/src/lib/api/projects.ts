...
export class ProjectAPI {
   ...
   * @returns 导出数据的下载链接
   */
  static async exportProject(id: string, format: 'json' | 'csv' | 'xlsx' = 'json'): Promise<string> {
   ...
   * @param role 角色
   */
  static async addProjectMembers(id: string, userIds: string[], role: string = 'member'): Promise<void> {
   ...
   * @returns 活动日志
   */
  static async getProjectActivities(id: string, params?: { page?: number; limit?: number }): Promise<any> {
