...
export function TabsTrigger(node: HTMLButtonElement, props: { class?: string; value: string } = { value: '' }) {
...
export function TabsContent(node: HTMLDivElement, props: { class?: string; value: string } = { value: '' }) {
