  ...
  <CardContent class="grid gap-4">
    <form use:form class="grid gap-4">
      ...
      <div class="flex items-center gap-2">
        <input id="agreeToTerms" name="agreeToTerms" type="checkbox" disabled={isLoading || $isSubmitting} />
        <Label for="agreeToTerms">我已阅读并同意 <a href="/terms" class="underline">服务协议</a></Label>
      </div>
